...
const PROMPT_DESCRIPTION =
  "Return the next_best_prompt end-of-turn rule: label who owns the next required " +
  "action, add 2-4 ranked copy-paste-ready next moves when useful, and skip the " +
  "menu entirely when there's no high-value next step.";
